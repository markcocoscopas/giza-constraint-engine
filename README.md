...
4. **Best-case feasibility only.** The programme reaches essentially zero deficit only under the Best Case preset — 800 t/d quarrying, 100,000 workers, 350 working days, and correspondingly elevated transport and dressing rates — a configuration no Egyptologist has proposed or defended.
